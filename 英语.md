...
| insight | 洞察、眼光 | Good teachers have insight into the problems of students. <br>好的教师能洞察学生的问题。|
| effectively | 有效 | This, effectively , gave them control over the whole process of production.<br>这有效地使他们能够控制整个生产过程。|
| refer | 参考 | |
| prevent | 防止 | The virtual environment installation is recommended in order to prevent package conflict and having the capacity to customize the working environment.<br>建议使用虚拟环境安装，以防止程序包冲突并具有自定义工作环境的能力。|
| tutorial | 教程 | Get extra copies of the tutorial notes from other sessions.<br> 从其他会话中获取教程说明的额外副本。|
| relevant | 相关 | We must keep it going long-term and make it relevant to people here and over there.<br> 我们必须长期保持这种状态，并使其与这里和那里的人们相关。|
| category | 类别 | The Act on Wine now distinguishes five categories of quality wines.<br> 现在，葡萄酒法案区分了五类优质葡萄酒。|
| partition | 划分 | n&v |